      ...
      <div className='relative max-w-7xl mx-auto p-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-5'>
          {stats.map((stat, i) => (
            <div
              key={i}
              className='group relative bg-white/80 backdrop-blur-xl border border-slate-200/80 rounded-2xl shadow-xl shadow-slate-200/50 p-6 hover:shadow-2xl hover:shadow-slate-300/50 transition-all duration-300 hover:-translate-y-1'
            >
        ...
        {/* Recent Activity */}
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/70 rounded-2xl shadow-slate-200/50 p-8'>
              ...
              {activities.map((activity, index) => (
                ...
                >
                  ...
                  {activity.link && (
                    <Link
                      to={activity.link}
                      className='ml-4 px-4 py-2 text-xs font-bold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all duration-200'
                    >
                      View
                    </Link>
                  )}
