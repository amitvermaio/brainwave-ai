          ...
          <div className='relative w-full max-w-md bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8'>
            ...
            <div className='flex gap-3'>
              ...
              <button
                ...
                disabled={deleting}
                className='flex-1 h-11 px-4 text-white bg-linear-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-sm font-semibold rounded-xl transition-all durations-200 shadow-lg shadow-red-500/25 hover:shadow-xl hover:shadow-red-500/30 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2'
              >
                {
                  deleting ? (
                    <span className='flex items-center justify-center gap-2'>
