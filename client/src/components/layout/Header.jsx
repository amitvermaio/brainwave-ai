    ...
    <header className='sticky top-0 z-40 w-full h-16 bg-white/80 backdrop-blur-xl border-b border-slate-200/60'>
      <div className='flex items-center justify-between h-full px-6'>
        ...
        <div className='flex items-center gap-3'>
          <button className='relative inline-flex items-center justify-center w-10 h-10 text-slate-600 hover:text-slate-900 hover:bg-slate-900 rounded-xl transition-all duration-200 group'>
            <Bell size={20} strokeWidth={2} className='group-hover:scale-110 transition-transform duration-200' />
            <span className='absolute top-1.5 right-1.5 w-2 h-2 bg-emerald-500 rounded-full ring-2 ring-white'></span>
          </button>

          {/* user profile */}
          <div className='flex items-center gap-3 pl-3 border-1 border-slate-200/60'>
            <div className='flex items-center gap-3 px-3 py-1.5 rounded-xl hover:bg-slate-50 transitions-colors duration-200 cursor-pointer group'>
              ...
              <div>
                <p className='font-sm font-semibold text-slate-900'>
                  {user?.name || 'User'}
                </p>
