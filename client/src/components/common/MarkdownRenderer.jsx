    ...
    <div className='text-neutral-700'>
      <ReactMarkdown
        ...
        components={{
          ...
          h4: (props) => <h4 className='text-sm font-bold mt-3 mb-2' {...props} />,
          ...
          blockquote: (props) => <blockquote className='border-l-4 border-neural-300 pl-4 italic text-neural-600 my-4' {...props} />,
